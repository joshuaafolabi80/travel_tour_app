// src/components/GeneralCourseQuestions.jsx - FIXED VERSION
import React, { useState, useEffect } from 'react';
import api from '../services/api';
import './CourseQuestions.css';

const GeneralCourseQuestions = ({ navigateTo }) => {
  ...
  const fetchQuestionSets = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        console.log(`✅ Loaded ${response.data.questionSets?.length || 0} general question sets`);
      } else {
  ...
  const attemptQuestions = (questionSet) => {
    ...
    console.log('🎯 Attempting general course questions:', questionSet.title);
    ...
    // 🚨 CRITICAL FIX: Navigate to general-quiz-attempt instead of quiz-platform
    if (navigateTo) {
            ...
            <div className="col-12 col-md-8 col-lg-6">
              <div className="card shadow-lg border-0">
                <div className="card-body text-center py-5">
                  ...
                  <h4 className="text-primary">Loading General Course Questions...</h4>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="row align-items-center">
                  <div className="col-md-8">
                    ...
                    <p className="lead mb-0 opacity-75">
                      Test your knowledge with these comprehensive question sets. Each set contains multiple questions to assess your understanding.
                    </p>
                  </div>
                  <div className="col-md-4 text-md-end">
                    <div className="bg-white rounded p-3 d-inline-block text-primary">
                      <h4 className="mb-0 fw-bold">{questionSets.length}</h4>
                      <small>Total Question Sets</small>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="row mb-4">
          <div className="col-12">
            <button 
              ...
              onClick={() => navigateTo('general-courses')}
            >
              ...
              <div className="card shadow-lg border-0">
                <div className="card-body text-center py-5">
                  ...
                  <p className="text-muted">
                    There are no general course question sets available at the moment. 
...
export default GeneralCourseQuestions;